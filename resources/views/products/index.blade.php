                                ...
                                @forelse ($products as $product)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full {{ $product->quantity > 10 ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                                                {{ $product->quantity }}
                                            </span>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">Rs. {{ number_format($product->price, 2) }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap font-semibold">Rs. {{ number_format($product->net_total, 2) }}</td>
